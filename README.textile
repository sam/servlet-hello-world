...
You'll need Java (OpenJDK7, it blows up on Java6 and I haven't bothered to find out why) and Maven and Buildr (@gem install buildr@) installed. Then you can just run:

bc. buildr jetty

Once you see the @Jetty started@ line (which takes about ten seconds for me), you can
