...
You'll need Java (OpenJDK7, it blows up on Java6 and I haven't bothered to find out why), Maven and "Buildr":https://github.com/apache/buildr (@gem install buildr@) installed. Then you can just run:
