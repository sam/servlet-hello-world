...
Once you see the @[INFO] Started Jetty Server@ line (which takes about thirty seconds for me), you can
navigate to http://localhost:8080/ in your web browser. The first hit may take around ten seconds as the
servlet is actually initialized for the first time.
